...
{
	fl_line(point(0).x - radius()/3, point(0).y - radius()/40, point(0).x + radius()*2, point(0).y - radius()/40);
	fl_line(point(0).x - radius() / 3, point(0).y - radius() / 10, point(0).x + radius() * 2, point(0).y - radius() / 10);
	fl_line(point(0).x - radius() / 3, point(0).y - radius() / 40, point(0).x - radius() / 3, point(0).y - radius() / 10);
	fl_line(point(0).x + radius() * 2, point(0).y - radius() / 40, point(0).x + radius()*2, point(0).y - radius() / 10);
	fl_line(point(0).x + radius()*2/1.5, point(0).y - radius() / 10, point(0).x + radius() * 2/1.5, point(0).y - radius() );
	fl_line(point(0).x + radius() *2/3    , point(0).y - radius() / 10, point(0).x+radius()*2/3 , point(0).y - radius());
	fl_line(point(0).x + radius() * 2 / 1.5, point(0).y - radius() , point(0).x + radius() * 2 / 3, point(0).y - radius());
